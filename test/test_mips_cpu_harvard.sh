...
if [[ $instruction != "all_cases" ]]; then
    ...
    for i in ${TESTCASES} ; do
        ...
        #compile program
        iverilog -g 2012 \
            -o test/4-Outputs/${TESTNAME} ${i} $1/mips_cpu_harvard.v $1/alucontrol.v $1/data_address_control.v $1/hilo.v $1/link.v $1/lw.v $1/pc_update.v $1/register_file.v $1/control.v $1/data_memory.v $1/instruction_memory.v $1/load.v $1/pc.v $1/unsign.v $1/alu.v $1/branch_data.v $1/shift_control.v $1/sb.v
